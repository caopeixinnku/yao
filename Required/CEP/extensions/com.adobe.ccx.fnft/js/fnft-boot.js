    ...
    initTemplates: function(stockData, licensedTemplates) {
        ...
        iaw.perf.set(iaw.perf.timers.JSLibLateLoad), iaw.util.loadExternalScript("js/marked.min.js").then(function(scriptTag) {
            ...
            if ("undefined" != typeof Ingest) {
                ...
                iaw.log.console("Cmd-N loading ends at: " + fnftLoadingEndTime), iaw.cepUtil.sendEvent(iaw.cepUtil.events.FNFTENDTIME, fnftLoadingEndTime.toString()), 
                iaw.perf.report(!0);
            }
        }), iaw.libraryManager.init(iaw.libraryManager.TEMPLATE_ELEMENT_TYPE), iaw.perf.measure(iaw.perf.timers.LoadTime, window.loadTime), 
